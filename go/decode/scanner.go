...
// LineCursor provides navigation through parsed lines
...
// Current returns the previously read line
...
// HasMoreAtDepth checks if there are more lines at the target depth
...
func ToParsedLines(source string, indentSize int, strict bool) (*ScanResult, error) {
	if strings.TrimSpace(source) == "" {
		return &ScanResult{Lines: []toon.ParsedLine{}, BlankLines: []toon.BlankLineInfo{}}, nil
	}
